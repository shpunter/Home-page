...
import Root from "/client/src/pages/root/root.tsx";
import { lazy, Suspense } from "react";
import DocSkeleton from "/client/src/UI/skeleton/docSkeleton/docSkeleton.tsx";

const Install = lazy(() => import("/client/src/pages/install/install.tsx"));
const Home = lazy(() => import("/client/src/pages/home/home.tsx"));
const Performance = lazy(() =>
  import("/client/src/pages/performance/performance.tsx")
);
const Add = lazy(() => import("/client/src/pages/add/add.tsx"));
const Sub = lazy(() => import("/client/src/pages/sub/sub.tsx"));
const Div = lazy(() => import("/client/src/pages/div/div.tsx"));
const Mul = lazy(() => import("/client/src/pages/mul/mul.tsx"));
const Round = lazy(() => import("/client/src/pages/round/round.tsx"));
const Pipe = lazy(() => import("/client/src/pages/pipe/pipe.tsx"));
const Sort = lazy(() => import("/client/src/pages/sort/sort.tsx"));
const Quartile = lazy(() => import("/client/src/pages/quartile/quartile.tsx"));
const Mean = lazy(() => import("/client/src/pages/mean/mean.tsx"));
const Max = lazy(() => import("/client/src/pages/max/max.tsx"));
const Min = lazy(() => import("/client/src/pages/min/min.tsx"));
const IsEqual = lazy(() => import("/client/src/pages/isEqual/isEqual.tsx"));
...
const Mad = lazy(() => import("/client/src/pages/MAD/MAD.tsx"));
const Iqr = lazy(() => import("/client/src/pages/IQR/IQR.tsx"));
const Sqrt = lazy(() => import("/client/src/pages/sqrt/sqrt.tsx"));
const Cbrt = lazy(() => import("/client/src/pages/cbrt/cbrt.tsx"));
const Abs = lazy(() => import("/client/src/pages/abs/abs.tsx"));
const ToBase = lazy(() => import("/client/src/pages/toBase/toBase.tsx"));
const IsHex = lazy(() => import("/client/src/pages/isHex/isHex.tsx"));
const IsBinary = lazy(() => import("/client/src/pages/isBinary/isBinary.tsx"));
const IsDecimal = lazy(() =>
  import("/client/src/pages/isDecimal/isDecimal.tsx")
);
const IsOctal = lazy(() => import("/client/src/pages/isOctal/isOctal.tsx"));
const IsNumber = lazy(() => import("/client/src/pages/isNumber/isNumber.tsx"));
