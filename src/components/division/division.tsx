...
console.log(largeResult); // Output: "${div(["98765432109876543210", "12345678901234567890"])}"`}
      </CodeBlock>
...
console.log(preciseResult); // Output: "${div(["1.123456789", "0.987654321"])}"`}
      </CodeBlock>
...
console.log(mixedBaseResult); // Output: "${div(["0x20", "0o10", "0b10", "2"])}"`}
      </CodeBlock>
